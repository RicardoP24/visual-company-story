  ...
  const testimonials = [
    {
      id: 1,
      name: "Neville Gayle",
      role: "CEO - Gayle Financial, USA",
      location: "Lisbon, Portugal",
      image: "/lovable-uploads/901c94bd-4e2a-43b2-adbd-933b23876f6e.png",
      rating: 5,
      text: "My family and I moved to Lisbon August 2022 and Ishmael was a major part of our move. We actually 'found' him by mistake as we looked for another real estate agency but the service was not that great so we decided to walk around the area and came across his firm at the time. We're beyond happy we experienced that bad service because without Ishmael our transition could not have gone better. He went above and beyond our expectations and we had quite a few lol. From securing an apartment ( fantastic location and space) for us while we had to go back to the US, helping us to navigate the public services so we could get all our utilities setup, applying for our NIFs, and picking us up at the airport plus countless video calls while we were still in the US his service was extremely professional. There's so much more he's done for us and continues to even after our move. My family and I would recommend his service without any hesitation and if we had to do this process over would for sure want to work with Ishmael. Fantastic human being!!",
      highlight: "Seamless relocation to Lisbon",
    ...
    },
    {
      ...
      location: "Portugal",
      image: "/lovable-uploads/a19f66aa-71c6-4894-b0b9-cbc0e97fbdea.png",
      rating: 5,
      text: "After following Ismael's sale of my parents' house, I decided to ask for advice on possible investments. He was tireless in the search for the best solutions for me and my family. Helped me at every stage of the process, from buying to remodeling and then selling In less than 6 months I managed to quadruple the invested capital! It has walked me through some of the biggest decisions I have had to make and for that I am forever grateful. We will certainly do more business together",
      highlight: "Quadrupled investment in 6 months",
      videoTestimonial: false
    },
    {
      id: 3,
      name: "Trevor Lyons",
      role: "International Investor, USA",
      location: "USA",
      image: "/lovable-uploads/9a81b7de-9d4a-45f6-aeb0-c5deed2026c4.png",
      rating: 5,
      ...
      highlight: "Expert guidance for investment property",
      videoTestimonial: false
    }
  ];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                ...
                <div className="lg:col-span-2 p-8 lg:p-12 bg-gradient-to-br from-gold/10 to-gold/5 relative">
                  ...
                  <div className="relative z-10">
                    <div className="w-full h-64 mx-auto mb-6 relative">
                      <img 
                        src={testimonials[currentTestimonial].image} 
                        alt={testimonials[currentTestimonial].name} 
                        className="w-full h-full object-cover rounded-lg border-4 border-gray-600/50 shadow-2xl" 
                      />
          ...
          <div className="flex items-center justify-between mt-8">
            ...
            <div className="flex space-x-3">
              {testimonials.map((_, index) => (
                <button key={index} onClick={() => goToTestimonial(index)} className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentTestimonial ? 'bg-gold scale-125' : 'bg-gray-600 hover:bg-gray-500'}`} />
              ))}
            </div>
        ...
        <div className={`mt-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '500ms' }}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.slice(0, 3).map((testimonial, index) => (
              <Card 
                key={testimonial.id} 
                className={`bg-gradient-to-br from-gray-900/50 to-black/50 border-gray-700/30 hover:border-gray-600/50 transition-all duration-500 cursor-pointer group ${index === currentTestimonial ? 'ring-2 ring-gray-600/50' : ''}`}
