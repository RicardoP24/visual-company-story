      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
        ...
        <div className="animate-fade-up">
          <h1 className="text-5xl md:text-7xl font-light text-white mb-6 tracking-wider">
            <span className="text-gold" style={{ fontFamily: "'Dancing Script', cursive" }}>Kings in</span>
            <br />
            <span className="text-white" style={{ fontFamily: "'Dancing Script', cursive" }}>Company</span>
          </h1>
