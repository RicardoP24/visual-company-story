...
export const Services = () => {
  ...
  const services = [
    {
      ...
      features: [
        ...
        "Personalized guidance based on your specific goals",
        "Comprehensive tools, frameworks, and resources",
        "Perfect for early-stage investors and planners"
      ],
      icon: Building,
    ...
    },
    {
      ...
      features: [
        ...
        "Market research and property negotiations",
        "Trusted legal, banking, and renovation partners",
        "From first homes to investment portfolios"
      ],
      icon: Users,
    ...
    },
    {
      ...
      features: [
        "Property visits with cultural immersion",
        "Complete itinerary and logistics handled",
        "Perfect for serious investors and relocators",
        "Expert guidance through Portugal or Cabo Verde"
      ],
      icon: MapPin,
    ...
    },
    {
      ...
      features: [
        "Renovation coordination and management",
        "Long-term rental tenant services",
        "Complete maintenance oversight",
  ...
  return (
    <section ref={sectionRef} id="services" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
      {/* Background Pattern */}
            ...
            >
              <CardContent className="p-0 h-full">
                ...
                <div className="p-8 bg-gradient-to-br from-gray-900 to-black border-t border-gold/20">
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full border-gold/30 text-gold hover:bg-gold hover:text-black transition-all duration-300 group-hover:border-gold"
                  >
                    LEARN MORE
                  </Button>
                </div>
