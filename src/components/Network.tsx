...
export const Network = () => {
  ...
  const networkCategories = [
    { name: "Investment Funds", id: 1 },
    { name: "Lawyers", id: 2 },
    { name: "Insurance Brokers", id: 3 },
    { name: "Interior Designers", id: 4 },
    { name: "Hospitality Groups", id: 5 },
    { name: "Banks", id: 6 },
    { name: "Engineers", id: 7 },
    { name: "Architects", id: 8 },
    { name: "Builders", id: 9 },
    { name: "Private Investors", id: 10 },
    { name: "Business Consultants", id: 11 },
    { name: "Appraisers", id: 12 },
    { name: "Real Estate Agents", id: 13 },
    { name: "Property Managers", id: 14 },
    { name: "Financial Advisors", id: 15 },
    { name: "Tax Consultants", id: 16 },
    { name: "Accountants", id: 17 },
    { name: "Contractors", id: 18 },
    { name: "Market Analysts", id: 19 },
    { name: "Project Managers", id: 20 }
  ];

  const stats = [
    { icon: Users, value: "200+", label: "Network Partners" },
    { icon: Building2, value: "15", label: "Industries Covered" },
    { icon: TrendingUp, value: "95%", label: "Success Rate" },
    { icon: Shield, value: "100%", label: "Vetted Professionals" }
  ];

  return (
    <section ref={sectionRef} id="network" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
      {/* Background Animation */}
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-gold/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-gold/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
      </div>
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-1 bg-gray-800/30 p-1 rounded-lg backdrop-blur-sm border border-gray-700">
            {networkCategories.map((category, index) => (
              <Card
                key={category.id}
                className={`bg-gradient-to-br from-[#A08F66]/20 to-[#8B7A52]/10 border-gray-700 hover:border-gold/50 transition-all duration-500 cursor-pointer group ${
                  hoveredCard === category.id ? 'scale-105 z-10' : ''
                }`}
